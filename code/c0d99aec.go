...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "timeout0" {
  ...
  } else if function == "vio2018-11-07" {
    return FsmEvent(stub, args, "vio2018-11-07")
  } else if function == "213213" {
    return FsmEvent(stub, args, "213213")
  } else if function == "vio2018-11-07" {
    return FsmEvent(stub, args, "vio2018-11-07")
    ...
    return FsmEvent(stub, args, "timeout1")
  } else if function == "213" {
    return FsmEvent(stub, args, "213")
  } else if function == "vio2018-11-06" {
    return FsmEvent(stub, args, "vio2018-11-06")
  } else if function == "timeout0" {
    return FsmEvent(stub, args, "timeout0")
  } else if function == "" {
    return FsmEvent(stub, args, "")
    ...
    return FsmEvent(stub, args, "timeout2")
  } else if function == "21321" {
    return FsmEvent(stub, args, "21321")
  } else if function == "vio2018-11-22" {
    return FsmEvent(stub, args, "vio2018-11-22")
  } else {
...
func (this *Routers) vio2018-11-07((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 213((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-11-06((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 21321((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-11-22((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
