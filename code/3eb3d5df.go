...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "timeout0" {
    ...
    return FsmEvent(stub, args, "213")
  } else if function == "vio2018-10-02" {
    return FsmEvent(stub, args, "vio2018-10-02")
  } else if function == "213" {
    return FsmEvent(stub, args, "213")
  } else if function == "vio2018-10-02" {
    return FsmEvent(stub, args, "vio2018-10-02")
    ...
    return FsmEvent(stub, args, "213")
  } else if function == "vio2018-10-11" {
    return FsmEvent(stub, args, "vio2018-10-11")
  } else if function == "timeout1" {
    return FsmEvent(stub, args, "timeout1")
  } else if function == "timeout0" {
    return FsmEvent(stub, args, "timeout0")
    ...
    return FsmEvent(stub, args, "213")
  } else if function == "vio2018-10-18" {
    return FsmEvent(stub, args, "vio2018-10-18")
  } else if function == "timeout1" {
    return FsmEvent(stub, args, "timeout1")
  } else if function == "timeout2" {
    return FsmEvent(stub, args, "timeout2")
...
func (this *Routers) vio2018-10-02((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) vio2018-10-11((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) vio2018-10-18((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
