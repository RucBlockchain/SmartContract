...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "exp-2018-11-02" {
    return FsmEvent(stub, args, "exp-2018-11-02")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "vio-2018-11-02" {
    return FsmEvent(stub, args, "vio-2018-11-02")
  } else {
...
func (this *Routers) exp-2018-11-02((stub shim.ChaincodeStubInterface,
...
func (this *Routers) vio-2018-11-02((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
