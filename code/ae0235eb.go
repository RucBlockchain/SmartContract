...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "exp-2018-11-15" {
    ...
    return FsmEvent(stub, args, "exp-2018-11-14")
  } else if function == "exp-2018-11-09" {
    return FsmEvent(stub, args, "exp-2018-11-09")
    ...
    return FsmEvent(stub, args, "")
  } else if function == "sdfsf" {
    return FsmEvent(stub, args, "sdfsf")
    ...
    return FsmEvent(stub, args, "exp-2018-11-14")
  } else if function == "sfsfs" {
    return FsmEvent(stub, args, "sfsfs")
  } else if function == "vio-2018-11-14" {
    return FsmEvent(stub, args, "vio-2018-11-14")
  } else if function == "exp-2018-11-15" {
    return FsmEvent(stub, args, "exp-2018-11-15")
    ...
    return FsmEvent(stub, args, "exp-2018-11-09")
  } else if function == "fsfsfsf" {
    return FsmEvent(stub, args, "fsfsfsf")
  } else if function == "vio-2018-11-09" {
    return FsmEvent(stub, args, "vio-2018-11-09")
  } else {
...
func (this *Routers) exp-2018-11-09((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) sdfsf((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) sfsfs((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) fsfsfsf((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio-2018-11-09((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
