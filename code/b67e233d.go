...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "timeout0" {
  ...
  } else if function == "sfsf" {
    return FsmEvent(stub, args, "sfsf")
  } else if function == "timeout1" {
    return FsmEvent(stub, args, "timeout1")
  } else if function == "ef" {
    return FsmEvent(stub, args, "ef")
    ...
    return FsmEvent(stub, args, "sfsf")
  } else if function == "vio2018-10-10" {
    return FsmEvent(stub, args, "vio2018-10-10")
  } else if function == "timeout0" {
    return FsmEvent(stub, args, "timeout0")
  } else if function == "sfsf" {
    return FsmEvent(stub, args, "sfsf")
...
func (this *Routers) sfsf((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) ef((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) vio2018-10-10((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
