...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "timeout0" {
    ...
    return FsmEvent(stub, args, "23")
  } else if function == "vio2018-11-13" {
    return FsmEvent(stub, args, "vio2018-11-13")
  } else {
...
func (this *Routers) 23((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-11-13((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
