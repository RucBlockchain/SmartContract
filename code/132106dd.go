...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "exp-2018-11-05" {
  ...
  } else if function == "exp-2018-11-06" {
    return FsmEvent(stub, args, "exp-2018-11-06")
    ...
    return FsmEvent(stub, args, "")
  } else if function == "transfer 100w" {
    return FsmEvent(stub, args, "transfer 100w")
    ...
    return FsmEvent(stub, args, "exp-2018-11-06")
  } else if function == "deliver house" {
    return FsmEvent(stub, args, "deliver house")
  } else if function == "vio-2018-11-06" {
    return FsmEvent(stub, args, "vio-2018-11-06")
  } else if function == "exp-2018-11-05" {
    return FsmEvent(stub, args, "exp-2018-11-05")
  } else if function == "" {
    return FsmEvent(stub, args, "")
...
func (this *Routers) exp-2018-11-06((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) transfer 100w((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) deliver house((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio-2018-11-06((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
