...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "exp-2018-11-14" {
    ...
    return FsmEvent(stub, args, "")
  } else if function == "233" {
    return FsmEvent(stub, args, "233")
    ...
    return FsmEvent(stub, args, "exp-2018-11-16")
  } else if function == "123123" {
    return FsmEvent(stub, args, "123123")
...
func (this *Routers) 233((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 123123((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
