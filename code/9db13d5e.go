...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "exp-2018-11-07" {
    return FsmEvent(stub, args, "exp-2018-11-07")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "exp-2018-11-15" {
    return FsmEvent(stub, args, "exp-2018-11-15")
  } else if function == "exp-2018-11-16" {
    return FsmEvent(stub, args, "exp-2018-11-16")
  } else if function == "exp-2018-11-14" {
    return FsmEvent(stub, args, "exp-2018-11-14")
  } else if function == "exp-2018-11-07" {
    return FsmEvent(stub, args, "exp-2018-11-07")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "exp-2018-11-15" {
    ...
    return FsmEvent(stub, args, "")
  } else if function == "asd" {
    return FsmEvent(stub, args, "asd")
  } else if function == "vio-2018-11-07" {
    return FsmEvent(stub, args, "vio-2018-11-07")
  } else if function == "asd" {
    return FsmEvent(stub, args, "asd")
  } else if function == "vio-2018-11-07" {
    return FsmEvent(stub, args, "vio-2018-11-07")
    ...
    return FsmEvent(stub, args, "asd")
  } else if function == "vio-2018-11-15" {
    return FsmEvent(stub, args, "vio-2018-11-15")
  } else if function == "exp-2018-11-07" {
    return FsmEvent(stub, args, "exp-2018-11-07")
  } else if function == "" {
    return FsmEvent(stub, args, "")
    ...
    return FsmEvent(stub, args, "asd")
  } else if function == "vio-2018-11-16" {
    return FsmEvent(stub, args, "vio-2018-11-16")
  } else if function == "exp-2018-11-07" {
    return FsmEvent(stub, args, "exp-2018-11-07")
  } else if function == "" {
    return FsmEvent(stub, args, "")
...
func (this *Routers) exp-2018-11-07((stub shim.ChaincodeStubInterface,
...
func (this *Routers) exp-2018-11-15((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) exp-2018-11-16((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) asd((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio-2018-11-07((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) vio-2018-11-15((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) vio-2018-11-16((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
