...
func (c *ContractChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
  ...
  if function == "timeout0" {
  ...
  } else if function == "timeout1" {
    return FsmEvent(stub, args, "timeout1")
  } else if function == "timeout2" {
    return FsmEvent(stub, args, "timeout2")
  } else if function == "timeout0" {
    return FsmEvent(stub, args, "timeout0")
  } else if function == "" {
    return FsmEvent(stub, args, "")
  } else if function == "timeout1" {
    ...
    return FsmEvent(stub, args, "")
  } else if function == "213213" {
    return FsmEvent(stub, args, "213213")
  } else if function == "vio2018-10-09" {
    return FsmEvent(stub, args, "vio2018-10-09")
  } else if function == "213213" {
    return FsmEvent(stub, args, "213213")
  } else if function == "vio2018-10-09" {
    return FsmEvent(stub, args, "vio2018-10-09")
    ...
    return FsmEvent(stub, args, "timeout1")
  } else if function == "213123" {
    return FsmEvent(stub, args, "213123")
  } else if function == "vio2018-11-14" {
    return FsmEvent(stub, args, "vio2018-11-14")
  } else if function == "timeout0" {
    return FsmEvent(stub, args, "timeout0")
  } else if function == "" {
    return FsmEvent(stub, args, "")
    ...
    return FsmEvent(stub, args, "vio2018-11-14")
  } else if function == "123213" {
    return FsmEvent(stub, args, "123213")
  } else if function == "vio2018-11-23" {
    return FsmEvent(stub, args, "vio2018-11-23")
  } else if function == "timeout2" {
    return FsmEvent(stub, args, "timeout2")
  } else {
...
func (this *Routers) timeout1((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) timeout2((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 213213((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-10-09((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 213123((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-11-14((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
...
func (this *Routers) 123213((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}


func (this *Routers) vio2018-11-23((stub shim.ChaincodeStubInterface,
args []string) (pb.Response, string) {
  return shim.Success(nil), "Done"
}
