...
// =============================================================
func (c *ContractChaincode) (stub shim.ChaincodeStubInterface) pb.Response {
  boolValue := getRand(2)
  if boolValue == 0 {
...
// ===================================================
func (c *ContractChaincode) check_delay(stub shim.ChaincodeStubInterface) pb.Response {
  boolValue := getRand(2)
  if boolValue == 0 {
    return shim.Success([]byte("true"))
  } else {
...
func (c *ContractChaincode) clientRegist(stub shim.ChaincodeStubInterface, args []string) pb.Response {
  ...
  clientJSON := &Client{clientID, objectType, publicKeyX, publicKeyY, account}
...
func (c *ContractChaincode) insurCompanyRegist(stub shim.ChaincodeStubInterface, args []string) pb.Response {
  ...
  companyJSON := &InsuranceCompany{companyIndexKey, objectType, publicKeyX, publicKeyY, account}
...
// ================================================
func (c *ContractChaincode) writeOrder(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
// =============================================================
//        initGuarantee - set guarantee init status Bought
// =============================================================
func (c *ContractChaincode) initGuarantee(stub shim.ChaincodeStubInterface, args []string) pb.Response {
